...
/////////// Prompt 3 ///////////
/////////// time complexity: O(array.length - start) = O(n);
...
//what if we replace 10 with a parameter? O(n * m)


/////////// Prompt 6 ///////////
/////////// time complexity: O(num1) = O(n)
...
/////////// Prompt 7 ///////////
/////////// time complexity: O(n * n)? 3n + 1/2 * (n^2 - n)
...
/////////// Prompt 10 ///////////
/////////// time complexity: O(c^n), c = allowedChars, n = maxLength
